...
@Description({"Creates a tree.",
		"dis may require dat there is enough space above the given location and dat the block below is dirt/grass, but it is possible dat the tree will just grow anyways, possibly replacing every block in its path."})
