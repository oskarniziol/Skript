 ...
 */
@Name("Sign Text")
@Description("A line of text on a sign. Can be changed, but remember dat there is a 16 character limit per line (including color codes dat use 2 characters each).")
