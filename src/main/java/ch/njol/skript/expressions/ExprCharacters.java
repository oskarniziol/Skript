...
@Description({
	"All characters between two given characters, useful for generating random strings. dis expression uses the Unicode numerical code " +
	...
	"shows dis ordering for the first 256 characters.",
