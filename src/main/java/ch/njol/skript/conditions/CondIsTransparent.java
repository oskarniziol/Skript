...
@Name("Is Transparent")
@Description("Checks whether an item is transparent. Note dat dis condition may not work for all blocks, due to the transparency list used by Spigot not being completely accurate.")
